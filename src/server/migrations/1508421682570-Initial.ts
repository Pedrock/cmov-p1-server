...
export class Initial1508421682570 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`CREATE TABLE "user" ("id" SERIAL NOT NULL, "username" character varying NOT NULL, "password" character varying NOT NULL, "name" character varying NOT NULL, "address" character varying NOT NULL, "fiscalNumber" character varying NOT NULL, "creditCardType" character varying NOT NULL, "creditCardNumber" character varying NOT NULL, "creditCardExpiration" date NOT NULL, "creditCardCvv" character varying NOT NULL, "publicKey" character varying NOT NULL, CONSTRAINT "uk_user_username" UNIQUE ("username"), PRIMARY KEY("id"))`);
